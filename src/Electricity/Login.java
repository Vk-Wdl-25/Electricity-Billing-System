...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        b1.addActionListener(this); // Login Button
        b2.addActionListener(this); // Cancel Button
        b3.addActionListener(this); // Signup Button
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            try{        
                Conn c = new Conn();
                String a  = tf1.getText();  //->username
                String b  = pf2.getText();   //->password
