...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        /* ---- JMenuItem m2 => Customer Meter Details ---- */
    ...
    //----------------------------------------------------------------------
        ...
        /* ---- JMenuItem info1 => Update Information ---- */
        ...
        /* ---- JMenuItem info2 => View Information ----*/
    ...
    //---------------------------------------------------------------------
        if(person.equals("Admin")){
            // If Login as ADMIN then only, show Master Menu With all rest (i.e. Utility & Exit) MenuItem
            mb.add(master);
        }
        else{ 
            // else as Customer show (Info, User, Rport, Utility & Exit)        
            mb.add(info);
            mb.add(user);
            mb.add(report);
        }
